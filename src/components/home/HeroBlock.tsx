...
export function HeroBlock({ myths, headline1, headline2, eyebrow }: Props) {
  ...
  useEffect(() => {
    ...
    function onVis() { window.clearInterval(cycleInt); if (!document.hidden) cycleInt = window.setInterval(runCycle, 3600); }
    ...
    return () => {
      ...
      stage.replaceChildren(); glyphRow.replaceChildren();
      pillEl.innerHTML = "";
    };
  }, [myths]);
    ...
    >
      ...
      <div className="cmhero__center">
        ...
        <div className="cmhero__exhibit" aria-hidden="true">
          ...
          <span className="cmhero__myth-label" aria-hidden="true">42 Mythen</span>
