...
export default function FactsheetPanel({
  ...
  const allSections = mythContentEntry
    ? splitSections(mythContentEntry.html)
    : [];
  ...
  const orderedSections = SECTION_ORDER.filter(
    (title) => !(hasInteractiveBars && title === GROUP_METRICS_SECTION),
  )
  ...
  const renderSection = (section: Section, i: number) => {
    ...
    if (isCollapsible) {
      return (
        <div
          key={i}
          className="factsheet-panel__section factsheet-panel__section--collapsible"
        >
          <button
            type="button"
        ...
        <div className="factsheet-panel__body">
          {mythContentEntry ? (
            <>
              ...
              {factsheetSlug && (
                ...
                >
                  ...
                  <span className="factsheet-panel__download-meta">
                    {PDF_SIZES[factsheetSlug]
                      ? `PDF · ${PDF_SIZES[factsheetSlug]}`
                      : "PDF"}
                  </span>
                </a>
              )}
              ...
              {SHOW_VERWANDTE_MYTHEN &&
                mythContentEntry.relatedMyths &&
                mythContentEntry.relatedMyths.length > 0 && (
                  <details className="factsheet-panel__section factsheet-panel__section--collapsible factsheet-panel__extras factsheet-panel__related">
                    <summary className="factsheet-panel__section-toggle">
                      ...
                      <span
                        className="factsheet-panel__chevron"
                        aria-hidden="true"
                      >
                        &#9662;
                      </span>
                    ...
                    <ul className="factsheet-panel__extras-list">
                      {mythContentEntry.relatedMyths.map((r) => {
                        ...
                        return (
                          <li
                            key={r.mythId}
                            className="factsheet-panel__extras-item"
                          >
                            {onSelectRelatedMyth ? (
                              <button
                                type="button"
                                ...
                                onClick={() =>
                                  onSelectRelatedMyth(r.mythNumber)
                                }
                              >
                                {inner}
                              </button>
