 ...
 *
 * Note: imports `useFlipPosition` from the dashboard's hooks folder
 * because that's the only consumer location today and the hook is
 * pure logic (no dashboard-specific dependencies). Moving the hook
 * itself was deliberately deferred — see the brand-voice/quiz/fakten
