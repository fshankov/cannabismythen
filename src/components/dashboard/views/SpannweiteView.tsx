...
const SpannweiteView = forwardRef<SpannweiteViewHandle, Props>(
  function SpannweiteView(
    ...
    const allColumnIds: string[] =
      mode === "indicator" ? (GROUP_IDS as string[]) : (INDICATORS as string[]);
    ...
    const columns = useMemo(() => {
      ...
      return GROUP_IDS.map((gid) => {
        ...
        const shortLabel =
          lang === "de" ? GROUP_SHORT_DE[gid] : GROUP_SHORT_EN[gid];
        return {
          id: gid as string,
    ...
    const sortedMyths = useMemo(() => {
      ...
      const cmpAz = (a: Myth, b: Myth) =>
        getMythShortText(a, lang).localeCompare(
          getMythShortText(b, lang),
          "de",
        );
        ...
        <div className="carm-spannweite__scroller">
          ...
          >
            ...
            {(() => {
              ...
              const isVerdictActive =
                sort === "verdict-asc" || sort === "verdict-desc";
              const verdictDir: "asc" | "desc" =
                sort === "verdict-desc" ? "desc" : "asc";
                ...
                >
                  <GridLabelHeader
                    ...
                    verdictRank={{
                      ...
                      onClick: () => {
                        if (sort === "verdict-asc")
                          update("spannweiteSort", "verdict-desc");
        ...
        {hoveredMyth &&
          ...
          (() => {
            ...
            if (hoveredColId) {
              ...
              lesebeispielGroup =
                mode === "indicator" ? (hoveredColId as GroupId) : pickedGroup;
            }
            return (
              <GridHoverTooltip
                myth={hoveredMyth}
