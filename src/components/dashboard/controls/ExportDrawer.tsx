...
const VERDICT_LEGEND = [
  {
    verdict: "richtig" as const,
    color: getCorrectnessColor("richtig"),
    key: "verdict.richtig" as const,
  },
  {
    verdict: "eher_richtig" as const,
    color: getCorrectnessColor("eher_richtig"),
    key: "verdict.eher_richtig" as const,
  },
  {
    verdict: "eher_falsch" as const,
    color: getCorrectnessColor("eher_falsch"),
    key: "verdict.eher_falsch" as const,
  },
  {
    verdict: "falsch" as const,
    color: getCorrectnessColor("falsch"),
    key: "verdict.falsch" as const,
  },
];
    ...
    >
      ...
      <div className="carm-export-list">
        <ExportRow
          ...
          title={t(
            isSources ? "export.csv.title.sources" : "export.csv.title",
            "de",
          )}
          desc={t(
            isSources ? "export.csv.desc.sources" : "export.csv.desc",
            "de",
          )}
        ...
        <ExportRow
          ...
          title={t(
            isSources ? "export.excel.title.sources" : "export.excel.title",
            "de",
          )}
          desc={t(
            isSources ? "export.excel.desc.sources" : "export.excel.desc",
            "de",
          )}
