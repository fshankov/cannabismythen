...
interface Props {
  ...
  /** Hide the indicator-tag row (used when a view ships its own indicator switcher). */
  hideIndicators?: boolean;
  /** Hide the population-group row (used when a view ships its own group switcher). */
  hideGroups?: boolean;
  /** Hide the Kategorien collapsible section (used when a view ships its own categories control). */
