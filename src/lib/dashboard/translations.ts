...
const translations = {
  // App header
  "app.title": {
    de: "Cannabis Mythen Explorer",
    en: "Cannabis Mythen Explorer",
  },
  "app.subtitle": {
  ...
  "indicator.significance": {
    de: "Bedeutung (Punkte)",
    en: "Significance (points)",
  },
  "indicator.correctness": {
    de: "Richtigkeit (Punkte)",
    en: "Correctness (points)",
  },
  ...
  "indicator.prevention_significance.short": {
    de: "Prävention",
    en: "Prevention",
  },
  "indicator.population_relevance.short": {
    de: "Bev. Relevanz",
    en: "Pop. Relevance",
  },
  ...
  "detail.checked": {
    de: "Wissenschaftlich geprüft",
    en: "Scientifically Checked",
  },
  "detail.notChecked": {
    de: "Keine Aussage möglich",
    en: "No classification possible",
  },
  ...
  "sources.metric.prevention": {
    de: "Präventionspotential",
    en: "Prevention Potential",
  },
  ...
  "sources_strips.picker.group": {
    de: "Bevölkerungsgruppe",
    en: "Population group",
  },
  "sources_strips.picker.metric": { de: "Indikator", en: "Indicator" },
  "sources_strips.children.show": {
    de: "Unterkategorien einblenden",
    en: "Show subcategories",
  },
  "sources_strips.category.all": {
    de: "Alle Informationswege",
    en: "All sources",
  },
  "sources_strips.count": { de: "{n} Informationswege", en: "{n} sources" },
  "sources_strips.action.showChildren": {
    de: "Unterkategorien zeigen",
    en: "Show subcategories",
  },
  "sources_strips.action.gotoParent": {
    de: "Zum Hauptthema",
    en: "Go to parent",
  },
  ...
  "view.quellen2": {
    de: "Informationswege-Übersicht",
    en: "Sources · Overview",
  },
  "view.quellen-tabelle": {
    de: "Informationswege-Tabelle",
    en: "Sources · Table",
  },
  ...
  "igs.group.young_adults": {
    de: "Junge Erwachsene (18–26)",
    en: "Young adults (18–26)",
  },
  ...
  "filter.title": {
    de: "Filter & Mythen-Auswahl",
    en: "Filter & myth selection",
  },
  ...
  "export.excel.title.sources": {
    de: "Excel (Informationswege)",
    en: "Excel (information channels)",
  },
  "export.excel.desc.sources": {
    de: "Alle Kanäle & Zielgruppen, 2 Tabellen.",
    en: "All channels & audience groups, 2 sheets.",
  },
  "export.csv.title.sources": {
    de: "CSV (Informationswege)",
    en: "CSV (information channels)",
  },
  ...
  "sources2.title": {
    de: "Informationswege-Spannweite",
    en: "Information-sources range",
  },
  ...
  "column.show": {
    de: "Spalte wieder einblenden",
    en: "Show this column again",
  },
  ...
  "datasetInfo.mythen.q1": {
    de: "Zu welchen Anteilen gekannt?",
    en: "Known by what share?",
  },
  "datasetInfo.mythen.q2": {
    de: "In welchem Ausmaß individuell bedeutsam?",
    en: "How individually significant?",
  },
  "datasetInfo.mythen.q3": {
    de: "In welchem Grad richtig beurteilt?",
    en: "How correctly judged?",
  },
  "datasetInfo.mythen.q4": {
    de: "Wie weit präventiv bedeutsam?",
    en: "How relevant for prevention?",
  },
  "datasetInfo.mythen.q5": {
    de: "Mit welcher Bevölkerungsrelevanz?",
    en: "With what population relevance?",
  },
  "datasetInfo.mythen.foot": {
    de: "Nach Zielgruppe zu betrachten.",
    en: "To be viewed by target group.",
  },
  "datasetInfo.wege.q1": {
  ...
  "datasetInfo.wege.q2": {
    de: "Wo werden solche Infos nebenbei wahrgenommen?",
    en: "Where is such info noticed incidentally?",
  },
  "datasetInfo.wege.q3": {
    de: "In welchem Ausmaß wird diesen Wegen vertraut?",
    en: "How much are these channels trusted?",
  },
  "datasetInfo.wege.q4": {
    de: "Für welche ergeben sich wie große Präventionspotentiale?",
    en: "Which yield how large a prevention potential?",
  },
  "datasetInfo.wege.foot": {
    de: "Nach Zielgruppe zu betrachten.",
    en: "To be viewed by target group.",
  },
} as const;
